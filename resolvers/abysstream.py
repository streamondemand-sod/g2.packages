...
def resolve(module, url):
    ...
    result = client.request('http://abysstream.com/viewvideo.php',
                            post='streamLink=%s&templink=%s'%(stream_link, temp_link),
                            referer=url, cookie="; ".join(cookie))
